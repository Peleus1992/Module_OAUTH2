...
import edu.gatech.wguo64.module_oauth2.backend.endpoints.TokenEndpoint;
...
public class NotificationHelper {
    private static final Logger logger = Logger.getLogger(TokenEndpoint
            .class.getName());
    ...
    public static void notify(Collection<String> userIds, String message) {
        ...
        for (String userId : userIds) {
            Token record = ofy().load().type(Token
